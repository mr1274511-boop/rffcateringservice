import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, R as React, e as reactDomExports, f as ReactDOM, X, g as React2, u as useLanguage, a as useNavigate, I as IslamicPattern, t } from "./index-DhBLjtS6.js";
import { a as composeRefs, u as useComposedRefs, c as cn, b as buttonVariants, B as Button } from "./button-D9mkWWJk.js";
import { B as Badge } from "./badge-BVogwwd4.js";
import { I as Input, L as Label } from "./label-OK4AqW0t.js";
import { O as OrderStatus, S as Skeleton, P as PaymentMethod, M as MenuCategory } from "./index-BnvbteiL.js";
import { P as Plus, T as Trash2, a as Textarea } from "./textarea-0vUaDYff.js";
import { u as useMenuItems, a as useAddMenuItem, b as useUpdateMenuItem, c as useRemoveMenuItem } from "./useMenu-DK9vAEK0.js";
import { c as useAllOrders, d as useUpdateOrderStatus } from "./useOrders-C-Bg32Im.js";
import { P as Package, R as RefreshCw } from "./refresh-cw-DBxK2ZTu.js";
...
const STATUS_BADGE = {
  ...
  [OrderStatus.beingPrepared]: "bg-secondary/30 text-foreground border-secondary/40",
...
function OrderRow({ order, index: index2 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      "data-ocid": `admin.order_row.${index2}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[10px] font-mono", children: payLabel }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: `text-[10px] ${STATUS_BADGE[order.status]}`, children: STATUS_LABELS[order.status] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs", children: order.contactNumber }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs leading-relaxed", children: order.items.map((item) => `${item.name} ×${item.quantity}`).join(" · ") }),
          order.notes && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-xs italic", children: [
            '" ',
            order.notes,
            ' "'
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row sm:flex-col items-center sm:items-end justify-between sm:justify-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-primary font-bold font-display text-lg", children: [
            "₹",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SelectTrigger,
                  {
                    ...
                    "data-ocid": `admin.order_status_select.${index2}`,
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {})
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: Object.values(OrderStatus).map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: s, children: STATUS_LABELS[s] }, s)) })
              ]
            }
          )
        ] })
...
function OrdersTab({
  ...
  const filtered = reactExports.useMemo(() => {
    ...
    return orders.filter((o) => {
      const matchSearch = !search || o.customerName.toLowerCase().includes(search.toLowerCase()) || o.orderId.toString().includes(search);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: statusFilter, onValueChange: setStatusFilter, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          ...
          Object.values(OrderStatus).map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: s, children: STATUS_LABELS[s] }, s))
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      ...
      statusFilter !== "all" && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs", children: STATUS_LABELS[statusFilter] })
    ] }),
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", "data-ocid": "admin.orders_loading_state", children: [1, 2, 3].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-28 w-full rounded-xl" }, i)) }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: (orders == null ? void 0 : orders.length) === 0 ? "No orders yet" : "No orders match your filter" })
        ]
      }
...
function MenuItemForm({
  ...
  const [priceStr, setPriceStr] = reactExports.useState(
    initial.price !== void 0 ? Number(initial.price).toString() : ""
  );
  const set = (key, val) => setForm((f) => ({ ...f, [key]: val }));
  const handleSubmit = (e) => {
    e.preventDefault();
    const price = priceStr ? BigInt(Math.round(Number.parseFloat(priceStr))) : void 0;
    onSave({ ...form, price });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "form",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("fieldset", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("legend", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-2", children: "Item Name" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs mb-1 block", children: "English" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                value: form.name.en,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs mb-1 block", children: "عربي (Arabic)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                value: form.name.ar,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs mb-1 block", children: "தமிழ் (Tamil)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                value: form.name.ta,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("fieldset", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("legend", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-2", children: "Description" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs mb-1 block", children: "English" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
                ...
                onChange: (e) => set("description", { ...form.description, ta: e.target.value }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs mb-1.5 block", children: "Price (₹)" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                type: "number",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs mb-1.5 block", children: "Category" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                value: form.category,
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: Object.values(MenuCategory).map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: c, children: CATEGORY_LABELS[c] }, c)) })
                ]
              }
            )
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs mb-1.5 block", children: "Image URL" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
              value: form.imageUrl,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 py-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "item-available", className: "text-sm cursor-pointer", children: "Available for ordering" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-2 sticky bottom-0 bg-popover pb-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              type: "submit",
              ...
              children: saving ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-3.5 h-3.5 border-2 border-primary-foreground/40 border-t-primary-foreground rounded-full animate-spin" }),
                "Saving…"
              ] }) : "Save Changes"
            }
          ),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-medium text-foreground", children: [
        ...
        " item",
        ((items == null ? void 0 : items.length) ?? 0) !== 1 ? "s" : ""
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: [1, 2, 3, 4].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-20 w-full rounded-xl" }, i))
      }
    ) : !items || items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "text-center py-16 bg-card/50 border border-dashed border-border rounded-xl",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "No menu items yet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              type: "button",
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: items.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      MenuItemCard,
      {
        item,
        index: i + 1,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: addOpen, onOpenChange: setAddOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg", "data-ocid": "admin.add_item_dialog", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display text-lg", children: "Add New Menu Item" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MenuItemForm,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: !!editItem, onOpenChange: (o) => !o && setEditItem(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "max-w-lg", "data-ocid": "admin.edit_item_dialog", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogTitle, { className: "font-display text-lg", children: [
        "Edit: ",
        editItem == null ? void 0 : editItem.name.en
      ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AlertDialog,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { "data-ocid": "admin.delete_confirm_dialog", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Delete Menu Item?" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
              "Are you sure you want to delete",
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: deleteTarget == null ? void 0 : deleteTarget.name.en }),
...
function MenuItemCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      "data-ocid": `admin.menu_item_row.${index2}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-medium text-sm truncate", children: item.name.en }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[10px]", children: CATEGORY_LABELS[item.category] }),
            !item.isAvailable && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Badge,
              {
                variant: "outline",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary text-xs font-display mt-1", children: item.price !== void 0 ? `₹${Number(item.price).toLocaleString("en-IN")}` : "Price not set" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              "data-ocid": `admin.edit_item_button.${index2}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              "data-ocid": `admin.delete_item_button.${index2}`,
...
function SettingsTab() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-lg space-y-6", "data-ocid": "admin.settings_panel", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-5 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-base font-semibold text-foreground", children: "Business Details" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("dl", { className: "space-y-3 text-sm", children: [
      ...
      ].map(([label, value]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("dt", { className: "text-muted-foreground w-32 shrink-0", children: label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("dd", { className: "text-foreground font-medium", children: value })
      ] }, label)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-base font-semibold text-foreground mb-3", children: "Admin Password" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
        "To change the admin password, update the",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "font-mono text-xs bg-muted px-1.5 py-0.5 rounded", children: "ADMIN_PASSWORD" }),
        " ",
        "constant in",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "font-mono text-xs bg-muted px-1.5 py-0.5 rounded", children: "AdminLoginPage.tsx" }),
        "."
      ] })
    ] })
  ] });
...
function AdminDashboardPage() {
  ...
  const pendingCount = (orders == null ? void 0 : orders.filter((o) => o.status !== OrderStatus.delivered).length) ?? 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", "data-ocid": "admin.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "bg-card border-b border-border py-5 sticky top-0 z-30 relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(IslamicPattern, { opacity: 0.05 }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 flex items-center justify-between relative z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-primary/15 border border-primary/30 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UtensilsCrossed, { size: 16, className: "text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl font-bold text-foreground leading-tight", children: t(language, "adminWelcome") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs", children: "RFF Catering Service" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/30 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-3 flex gap-6", children: [
      ["Total Orders", String((orders == null ? void 0 : orders.length) ?? 0)],
      ["Active", String(pendingCount)],
      ["Menu Items", String((menuItems == null ? void 0 : menuItems.length) ?? 0)]
    ].map(([label, value]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-display font-bold text-primary", children: value }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: label })
    ] }, label)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "orders", "data-ocid": "admin.tabs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "mb-6 bg-card border border-border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TabsTrigger,
          {
            value: "orders",
            ...
            children: [
              ...
              t(language, "orders"),
              pendingCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "ml-1 bg-primary/20 text-primary border-primary/30 text-[10px] px-1.5 py-0", children: pendingCount })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          TabsTrigger,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(UtensilsCrossed, { size: 14 }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "menu", children: /* @__PURE__ */ jsxRuntimeExports.jsx(MenuTab, { items: menuItems, loading: menuLoading }) }),
