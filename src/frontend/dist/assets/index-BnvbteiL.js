...
import { i as ProtocolError, T as TimeoutWaitingForResponseErrorCode, k as utf8ToBytes, E as ExternalError, l as MissingRootKeyErrorCode, C as Certificate, m as lookupResultToBuffer, n as RequestStatusResponseStatus, U as UnknownError, o as RequestStatusDoneNoReplyErrorCode, p as RejectError, q as CertifiedRejectErrorCode, s as UNREACHABLE_ERROR, v as InputError, w as InvalidReadStateRequestErrorCode, x as ReadRequestType, y as Principal, z as IDL, A as MissingCanisterIdErrorCode, H as HttpAgent, B as encode, Q as QueryResponseStatus, D as UncertifiedRejectErrorCode, F as isV3ResponseBody, G as isV2ResponseBody, J as UncertifiedRejectUpdateErrorCode, K as UnexpectedErrorCode, N as decode, S as Subscribable, O as pendingThenable, V as resolveEnabled, W as shallowEqualObjects, Y as resolveStaleTime, Z as noop, _ as environmentManager, $ as isValidTimeout, a0 as timeUntilStale, a1 as timeoutManager, a2 as focusManager, a3 as fetchState, a4 as replaceData, a5 as notifyManager, a6 as hashKey, a7 as getDefaultState, r as reactExports, a8 as shouldThrowError, h as useQueryClient, a9 as useInternetIdentity, aa as createActorWithConfig, j as jsxRuntimeExports, ab as Record, ac as Variant, ad as Opt, ae as Vec, af as Nat, ag as Service, ah as Func, ai as Null, aj as Text, ak as Bool, al as Int, am as Principal$1 } from "./index-DhBLjtS6.js";
import { c as cn } from "./button-D9mkWWJk.js";
...
const PaymentMethod$1 = Variant({ "qr": Null, "cod": Null });
const Timestamp = Int;
const OrderId = Nat;
...
const PlaceOrderInput = Record({
  ...
  "contactNumber": Text,
  "items": Vec(
    Record({ "quantity": Nat, "menuItemId": MenuItemId })
  )
});
Service({
  "_initializeAccessControl": Func([], [], []),
  "addMenuItem": Func([NewMenuItemInput], [MenuItem], []),
  ...
  "getOrderStatus": Func([OrderId], [Opt(OrderStatus$1)], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "placeOrder": Func([PlaceOrderInput], [Order], []),
  "removeMenuItem": Func([MenuItemId], [Bool], []),
  "updateMenuItem": Func(
    [MenuItemId, NewMenuItemInput],
    [Opt(MenuItem)],
    []
  ),
  "updateOrderStatus": Func([OrderId, OrderStatus$1], [Opt(Order)], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const I18nText2 = IDL2.Record({
    "ar": IDL2.Text,
    "en": IDL2.Text,
    "ta": IDL2.Text
  });
  ...
  const NewMenuItemInput2 = IDL2.Record({
    "name": I18nText2,
    "isAvailable": IDL2.Bool,
    "description": I18nText2,
    "imageUrl": IDL2.Text,
  ...
  const PaymentMethod2 = IDL2.Variant({ "qr": IDL2.Null, "cod": IDL2.Null });
  ...
  const PlaceOrderInput2 = IDL2.Record({
    ...
    "contactNumber": IDL2.Text,
    "items": IDL2.Vec(
      IDL2.Record({ "quantity": IDL2.Nat, "menuItemId": MenuItemId2 })
    )
  });
  return IDL2.Service({
    "_initializeAccessControl": IDL2.Func([], [], []),
    "addMenuItem": IDL2.Func([NewMenuItemInput2], [MenuItem2], []),
    ...
    "getOrderStatus": IDL2.Func([OrderId2], [IDL2.Opt(OrderStatus2)], ["query"]),
    "isCallerAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "placeOrder": IDL2.Func([PlaceOrderInput2], [Order2], []),
    "removeMenuItem": IDL2.Func([MenuItemId2], [IDL2.Bool], []),
    "updateMenuItem": IDL2.Func(
      [MenuItemId2, NewMenuItemInput2],
      [IDL2.Opt(MenuItem2)],
      []
    ),
...
function from_candid_MenuCategory_n7(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n8(_uploadFile, _downloadFile, value);
}
function from_candid_MenuItem_n5(_uploadFile, _downloadFile, value) {
  return from_candid_record_n6(_uploadFile, _downloadFile, value);
}
function from_candid_OrderStatus_n15(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n16(_uploadFile, _downloadFile, value);
}
function from_candid_Order_n13(_uploadFile, _downloadFile, value) {
  return from_candid_record_n14(_uploadFile, _downloadFile, value);
}
function from_candid_PaymentMethod_n17(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n16(_uploadFile, _downloadFile, value) {
  return "placed" in value ? "placed" : "beingPrepared" in value ? "beingPrepared" : "delivered" in value ? "delivered" : "ready" in value ? "ready" : value;
}
function from_candid_variant_n18(_uploadFile, _downloadFile, value) {
  return "qr" in value ? "qr" : "cod" in value ? "cod" : value;
}
...
function from_candid_variant_n8(_uploadFile, _downloadFile, value) {
  return "other" in value ? "other" : "rice" in value ? "rice" : "sides" in value ? "sides" : "sweets" in value ? "sweets" : "biryani" in value ? "biryani" : value;
}
...
function to_candid_NewMenuItemInput_n1(_uploadFile, _downloadFile, value) {
...
function to_candid_PlaceOrderInput_n24(_uploadFile, _downloadFile, value) {
...
var MenuCategory = /* @__PURE__ */ ((MenuCategory2) => {
  MenuCategory2["other"] = "other";
  MenuCategory2["rice"] = "rice";
  MenuCategory2["sides"] = "sides";
  MenuCategory2["sweets"] = "sweets";
  MenuCategory2["biryani"] = "biryani";
  return MenuCategory2;
})(MenuCategory || {});
var OrderStatus = /* @__PURE__ */ ((OrderStatus2) => {
  OrderStatus2["placed"] = "placed";
  OrderStatus2["beingPrepared"] = "beingPrepared";
  OrderStatus2["delivered"] = "delivered";
  OrderStatus2["ready"] = "ready";
  return OrderStatus2;
})(OrderStatus || {});
var PaymentMethod = /* @__PURE__ */ ((PaymentMethod2) => {
  PaymentMethod2["qr"] = "qr";
